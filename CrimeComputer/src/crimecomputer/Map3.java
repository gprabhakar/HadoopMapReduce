 ...
 * @author prabh_000
 */
public class Map3 extends MapReduceBase implements Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        if(line!=null)
        {
          words=line.split(",");
             ...
             {  
                 ...
                 {
                 crimedetails=Easting.charAt(0)+Easting.charAt(1)+Easting.charAt(2)+"XX,"+ Northing.charAt(0)+Northing.charAt(1)+Northing.charAt(2)+"XX,"+CrimeType;
